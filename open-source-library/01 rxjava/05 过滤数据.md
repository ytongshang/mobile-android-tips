...
![sample](../../image-resources/rxjava_sample.png)
...
![sample](../../image-resources/throttleFirst.png)
...
![sample](../../image-resources/debounce.png)
...
- 也就是说，原publish产生一个数据后，如果在接下的timeout时间内没有产生数据，则再次发射
 这个数据，否则忽略这个数据